...
@section('title', 'Sewing Manager Dashboard')
@section('page-title')
    <i class="bi bi-scissors me-2" style="color:#7c3aed"></i>Sewing Dashboard
@endsection
...
@if($queue->hasOvertime())
    <div class="alert alert-danger overtime-alert d-flex align-items-center gap-3 mb-4 shadow-sm" role="alert">
        ...
        <div class="flex-grow-1">
            <div class="fw-bold fs-5">SEWING OVERTIME REQUIRED TODAY</div>
            ...
            @if(!empty($queue->unitsByProductType))
                <div class="d-flex flex-wrap gap-2 mt-2">
                    @foreach($queue->unitsByProductType as $type => $units)
                        @php $rate = \App\Models\CapacityConfig::rateFor('sew', $type); @endphp
    ...
    <div class="col-6 col-sm-3">
        <div class="card stat-card shadow-sm h-100">
            <div class="card-body d-flex align-items-center gap-3 p-3">
                ...
                <div>
                    <div class="stat-number" style="color:#7c3aed">{{ count($queue->orders) }}</div>
        ...
        <div class="card stat-card shadow-sm h-100">
            <div class="card-body d-flex align-items-center gap-3 p-3">
                ...
                <div>
                    ...
                    <div class="text-muted" style="font-size:.75rem">Units to Sew</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card-body py-3">
        <div class="d-flex justify-content-between align-items-center mb-2">
            <span class="fw-semibold">
                <i class="bi bi-scissors me-2" style="color:#7c3aed"></i>Sewing Workload Today
            </span>
            ...
            <div class="d-flex flex-wrap gap-2">
                @foreach($queue->unitsByProductType as $type => $units)
                    ...
                    <div class="badge bg-light text-dark border px-3 py-2" style="font-size:.8rem">
                        ...
                        <span class="text-muted ms-1">({{ $rate }}/day → {{ round(($units/$rate)*100) }}% of day)</span>
                    </div>
                @endforeach
            </div>
        @endif
...
<div class="d-flex justify-content-end mb-2">
    <a href="{{ route('history.index', ['department' => 'sew']) }}" class="btn btn-sm btn-outline-secondary">
...
<div class="row g-4">
    ...
    <div class="col-12 col-xl-8">
        <div class="section-title">
            <i class="bi bi-calendar-day me-2" style="color:#7c3aed"></i>
            Today's Sewing Queue
        ...
        <div class="card shadow-sm border-0 mb-4">
            ...
            @if(empty($priorityJobs))
                <div class="card-body text-center py-4 text-muted">
                    ...
                    No rush or critical sewing jobs today
                </div>
            @else
