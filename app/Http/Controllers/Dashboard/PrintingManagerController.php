...
class PrintingManagerController extends Controller
{
    ...
    public function performance(Request $request): View
    {
        ...
        $perf     = $this->perfStats('print', $from, $to);
        $perfMine = $this->perfStats('print', $from, $to, auth()->id());

        return view('dashboard.printing-performance', compact('perf', 'perfMine', 'from', 'to', 'period'));
    }
}
